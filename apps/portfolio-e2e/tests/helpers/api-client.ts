...
// Returns headers that bypass Vercel Deployment Protection without including
// the app-level API key — used to test that the app itself rejects unauthenticated requests.
export function bypassOnlyHeaders(): Record<string, string> {
